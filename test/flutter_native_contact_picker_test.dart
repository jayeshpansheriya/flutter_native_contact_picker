...
void main() {
  final FlutterNativeContactPickerPlatform initialPlatform = FlutterNativeContactPickerPlatform.instance;

  test('$MethodChannelFlutterNativeContactPicker is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelFlutterNativeContactPicker>());
  });

  test('getPlatformVersion', () async {
    FlutterNativeContactPicker flutterNativeContactPickerPlugin = FlutterNativeContactPicker();
